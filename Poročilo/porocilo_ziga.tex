...
Kar je zanimivo je, da ni ena izmed konstrukcij zmeraj boljša. Za $n \in \{14, ~20, ~26\}$ ima namreč najmanjše število podpoti \emph{Cat2}, medtem ko je za $n = 32, ~38, ~44, \dots$ boljši graf \emph{Cat1}.\\
...
(Še nedokončan razdelek)

\subsection{Simulated annealing}

Želimo vedeti, če naše konstrukcije minimizirajo število podpoti za kubične grafe na $n$ vozliščih. Ker smo za $n \in \{10, ~12, ~14, ~16, ~18, ~20\}$ pregledali vse kubične grafe, lahko z gotovostjo trdimo, da konstrukcija \emph{Cat2} minimizira subpath number za kubične grafe na $n$ vozliščih za $n \in \{10, ~12, ~14, ~16, ~18, ~20\}$.\\
