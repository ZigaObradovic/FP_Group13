...
Za manjše $n$ želimo domnevo preveriti izčrpno, zato potrebujemo generator vseh neizomorfnih povezanih kubičnih grafov na $n$ vozliščih. 
Uporabimo vgrajeno funkcijo v SageMath-u (nauty\_geng), ki temelji na programu \emph{geng} iz paketa \emph{nauty}.
S parametri tej funkciji predpišemo, da:
\begin{itemize}
\item ima vsak graf natanko $n$ vozlišč,
\item je minimalna in maksimalna stopnja vozlišč enaka $3$ (graf je kubičen),
