...
\caption{Grafi z najmanjšim številom poti za $n=18$ (naraščajoče od leve proti desni).}
\label{fig:n18_grafi}
\end{figure}
...
\section{Zaključek in izris najboljših grafov}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{slike/vsi_naj2.png}
\caption{Grafi z najmanjšim številom poti za $n \in \{34, ~36, \dots, ~56\}$.}
\label{fig:vsi_naj2}
\end{figure}
